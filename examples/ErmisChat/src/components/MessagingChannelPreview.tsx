...
import {
  MessagingChannelPreview as MessagingChannelPreviewMessenger,
  MessagingChannelPreviewProps,
  MenuPointHorizontal,
  useChatContext,
  useTheme,
...
export const MessagingChannelPreview: React.FC<MessagingChannelPreviewProps<ErmisChatGenerics>> = (
  props,
) => {
  const { channel } = props;
  ...
  return (
    ...
    >
      <MessagingChannelPreviewMessenger {...props} />
    </Swipeable>
  );
};
