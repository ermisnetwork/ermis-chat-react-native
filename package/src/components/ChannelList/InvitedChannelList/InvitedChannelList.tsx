...
> = Partial<
    ...
    >
> & {
    /** Optional function to filter channels prior to rendering the list. Do not use any complex logic that would delay the loading of the InvitedChannelList. We recommend using a pure function with array methods like filter/sort/reduce. */
 ...
 * The InvitedChannelList doesn't provide any UI for the underlying React Native FlatList. UI is determined by the `List` component which is
 * provided to the InvitedChannelList component as a prop. By default, the ChannelListMessenger component is used as the list UI.
 *
 * @example ./InvitedChannelList.md
 */
export const InvitedChannelList = <
    ErmisChatGenerics extends DefaultErmisChatGenerics = DefaultErmisChatGenerics,
>(
    ...
    const {
        ...
        List = InvitedChannelListMessenger,
        ListHeaderComponent,
